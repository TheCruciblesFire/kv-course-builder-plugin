...
Version `0.5.0` is a regression candidate, not production. Do not promote it until the installed workspace instance passes the post-install smoke set. After production release, functional changes require a new immutable version.
